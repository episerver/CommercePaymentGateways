...
namespace PaymentProviders.DIBS
{
    ...
    public class DIBSPaymentOption : IPaymentOption
    {
        ...
        public DIBSPaymentOption() : this(ServiceLocator.Current.GetInstance<IOrderGroupFactory>())
        {
        }

        public DIBSPaymentOption(IOrderGroupFactory orderGroupFactory)
        {
